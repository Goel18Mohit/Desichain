...
public class RatingReviews extends AppCompatActivity  implements View.OnClickListener{
    ...
    public void navigationCategoryList(){
        final ShowCategoryAdapeter showCategoryAdapeter=new ShowCategoryAdapeter(RatingReviews.this,arrayList,hashMap,listView);
        ...
        listView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                Intent intent=new Intent(RatingReviews.this,Childcategoru.class);
